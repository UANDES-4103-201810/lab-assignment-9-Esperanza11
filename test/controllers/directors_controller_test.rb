...
class DirectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create director" do
    assert_difference('Director.count') do
      post directors_url, params: { director: { birthday: @director.birthday, description: @director.description, first_name: @director.first_name, last_name: @director.last_name } }
    end
  ...
  test "should update director" do
    patch director_url(@director), params: { director: { birthday: @director.birthday, description: @director.description, first_name: @director.first_name, last_name: @director.last_name } }
